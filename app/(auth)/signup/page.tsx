...
export default function SignUpPage() {
  ...
  async function signUp(){
    const {error} = await authClient.signUp.email({ name , email, institution, password})
    if (error) {
        ...
        <div className="bg-card -m-px rounded-[calc(var(--radius)+.125rem)] border p-8 pb-6">
          <div className="text-center">
            <Link
              ...
              <Image src='/brand/logo_white.png' height={50} width={50} alt='orunos brand Logo in white'/>
            </Link>
          ...
          <div className="mt-6 space-y-6">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Input type="text" required name="firstname" id="firstname" onChange={(e) => setFirstName(e.target.value)}/>
              </div>

              <div className="space-y-2">
                <Label htmlFor="lastname" className="block text-sm"> Last name </Label>
                <Input type="text" required name="lastname" id="lastname" onChange={(e) => setLastName(e.target.value)}/>
              </div>
            </div>
            ...
            <div className="space-y-0.5">
              ...
              <Input type="password" required name="pwd" id="pwd" className="input sz-md variant-mixed" onChange={(e) => setPassword(e.target.value)}/>
            </div>
