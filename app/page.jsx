...
const App = () => {
  return (
    <div className='h-screen w-screen bg-amber-700'>
      ...
      <div id="hero" className="min-h-screen w-full bg-orange-500 relative flex flex-col items-center justify-center" style={{backgroundImage: 'url(/images/tree.jpg)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
        <div id="call-to-action" className="flex flex-col gap-6 items-center justify-center">
          ...
          <h2 className="text-4xl text-white font-crimson-text motion-preset-focus motion-duration-1000 text-center">WRITE CITE LEARN</h2>
