...
const App = () => {
  ...
  return (
    <div className='h-screen w-screen bg-amber-700'>
      ...
      <div id="hero" className="min-h-screen w-full bg-orange-500 relative flex flex-col items-center justify-center" style={{backgroundImage: 'url(/images/boat.jpg)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
