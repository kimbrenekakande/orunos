        ...
        <div className="container px-4 md:px-6">
          <div className="mx-auto max-w-2xl text-center mb-12">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Have questions about Orunos? We&apos;d love to hear from you. Send us a message and we&apos;ll respond as soon as possible.
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-transparent">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <p className="font-medium text-sm">Do you offer enterprise pricing?</p>
                    <p className="text-sm text-muted-foreground">
                      Yes! Contact us for custom enterprise solutions tailored to your organization&apos;s needs.
                    </p>
                  </div>
                </CardContent>
              </Card>
