									...
									<Dialog>
										<form>
											<DialogTrigger asChild>
												<Button
													size="sm"
													className="gap-1.5 bg-black text-white hover:bg-primary-foreground/25 border-0 cursor-pointer"
												>
											...
											<DialogContent className="sm:max-w-sm">
												<DialogHeader>
													...
													<DialogDescription>
														Recharge your wallet here. Click proceed when you
														are done.
													</DialogDescription>
												...
												<FieldGroup className="mt-4">
													<Field>
														<Label htmlFor="username-1" className="hidden">
															Amout
														</Label>
														<Input
															id="amount-1"
					...
					<Table>
						<TableHeader>
							<TableRow className="border-b border-border/60 hover:bg-transparent">
								<TableHead className="h-10 text-[10px] uppercase tracking-[0.1em] text-muted-foreground font-semibold">
									Date
								</TableHead>
								<TableHead className="h-10 text-[10px] uppercase tracking-[0.1em] text-muted-foreground font-semibold">
									Description
								</TableHead>
								<TableHead className="h-10 text-[10px] uppercase tracking-[0.1em] text-muted-foreground font-semibold text-center">
									Type
								</TableHead>
								<TableHead className="h-10 text-[10px] uppercase tracking-[0.1em] text-muted-foreground font-semibold text-right">
									Amount
								</TableHead>
								<TableHead className="h-10 text-[10px] uppercase tracking-[0.1em] text-muted-foreground font-semibold text-right">
									Balance
								</TableHead>
								<TableHead className="h-10 text-[10px] uppercase tracking-[0.1em] text-muted-foreground font-semibold text-right pr-4">
									Invoice
								</TableHead>
							</TableRow>
						</TableHeader>
							...
							{transactions.map((transaction, index) => (
								...
								>
									...
									<TableCell className="py-3 text-center">
										<span
											className={`inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-medium border border-border/50 ${
