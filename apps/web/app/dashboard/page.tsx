	...
	return (
		<div className="">
			<div className="mx-0 sm:mx-8 mt-8 sm:mt-12">
				<h2 className="text-xl sm:text-3xl text-center sm:text-left font-header">
				...
				<section className="mx-0 sm:mx-8 mt-6 sm:mt-8">
					...
					<div className="flex justify-between items-center gap-3 py-3 px-1">
						<div className="flex items-center gap-2 min-w-0">
							...
							<p className="text-xs sm:text-sm text-amber-700 dark:text-amber-300 truncate">
			...
			<section className="mx-0 sm:mx-8 mt-10 sm:mt-12 mb-6 sm:mb-0">
				<h3 className="text-base sm:text-lg text-center sm:text-left mb-4">
					Start a new paper
				</h3>
				<TemplateGallery />
			</section>
...
function StatBadge({
	...
	return (
		<div
			className={`flex items-center gap-2 rounded-lg border ${sizes[size]} ${styles[variant]} ${className}`}
		>
			{icon}
