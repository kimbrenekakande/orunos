...
export const metadata: Metadata = {
	...
	description:
		"Your Academic Copilot to Ace all your academic documents from as simple as coursework to as complex as research",
...
export default function RootLayout({
	...
	return (
		<html lang="en" suppressHydrationWarning>
			...
			<body
				className={`${inter.variable} ${nexa.variable} ${geistMono.variable} ${ebGaramond.variable} antialiased`}
			>
				<ThemeProvider
					attribute="class"
					defaultTheme="system"
