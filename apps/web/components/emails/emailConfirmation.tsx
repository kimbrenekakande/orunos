    ...
    <Body className="bg-white font-slack mx-auto my-0">
      ...
      <Container className="mx-auto my-0 py-0 px-5">
        <Section className="mt-8">
          {/*<Img
            src={`${process.env.NEXT_PUBLIC_BASE_URL}/brand/logo_black.png`}
            width="120"
            height="36"
            alt="Slack"
          />*/}
        ...
        <Text className="text-black text-sm leading-6">
          If you didnt request this email, theres nothing to worry about,
        ...
        <Section>
          <Row className="mb-8 pl-2 pr-2">
            <Column className="w-2/3">
              {/*<Img
              src={`@/public/brand/logo_black.png`}
                width="120"
                height="36"
                alt="Slack"
              />*/}
        ...
        <Section>
          ...
          <Text className="text-xs leading-[15px] text-left mb-[50px] text-[#b7b7b7]">
            ©2026 Magezi Technologies, LLC, a Magezi company. <br />
