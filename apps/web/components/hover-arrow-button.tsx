...
export default function HoverArrowButton({
	...
	return (
		<motion.button
			className={cn(
				"group relative inline-flex items-center justify-center overflow-hidden rounded bg-black px-6 py-3 text-white transition-all dark:bg-white dark:text-black text-base font-medium cursor-pointer active:scale-[0.97]",
				className,
			)}
			whileHover="hover"
			initial="initial"
