...
export default function AI_Prompt() {
  ...
  return (
    <div className="w-full sm:w-4/6 py-4">
      <div className="rounded bg-black/5 p-1.5 pt-4 dark:bg-white/5 shadow-xs shadow-white">
        ...
        <div className="relative">
          <div className="relative flex flex-col">
            ...
            <div className="flex h-14 items-center rounded bg-transparent dark:bg-transparent">
              <div className="absolute right-3 bottom-3 left-3 flex w-[calc(100%-24px)] items-center justify-between">
                <div className="flex items-center gap-2">
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        className="flex hidden h-8 items-center gap-1 rounded-md pr-2 pl-1 text-xs hover:bg-black/10 focus-visible:ring-1 focus-visible:ring-blue-500 focus-visible:ring-offset-0 dark:text-white dark:hover:bg-white/10"
                        variant="ghost"
                      >
                  ...
                  <div className="mx-0.5 h-4 w-px bg-black/10 dark:bg-white/10 hidden" />
                  <label
