...
async function main() {
	...
	const userId = "ojteNkqqwKfDqpUBhn4w4Fv1Qp1rlZz9";
	const sampleDocuments = [
		{
			title: "Machine Learning Applications in Diagnostic Radiology",
			question:
				"Discuss the role of machine learning algorithms in improving diagnostic accuracy in medical imaging, including specific case studies and current limitations.",
			answer:
		...
		},
		{
			...
			question:
				"Analyze the impact of climate change on agricultural productivity in East Africa and evaluate existing adaptation strategies.",
			answer:
				"East Africa's agricultural sector faces mounting threats from shifting rainfall patterns, rising temperatures, and increased frequency of extreme weather events. Smallholder farmers have adopted strategies such as drought-resistant crop varieties, improved water harvesting techniques, and agroforestry practices. Policy interventions including index-based insurance and early warning systems show promise, but scalability remains limited by infrastructure gaps and limited access to financing.",
			status: "READY" as const,
			cost: 10000,
			docTypeId: "research",
		},
		{
			...
			question:
				"Evaluate the implementation of zero trust architecture in a large enterprise environment, covering challenges, outcomes, and best practices.",
			answer:
		...
		},
		{
			...
			question:
				"Conduct a comprehensive literature review on quantum computing, covering theoretical foundations, current hardware capabilities, and projected applications.",
			answer: null,
		...
		},
		{
			...
			question:
				"Examine how microfinance institutions contribute to women's economic empowerment in developing economies, including both successes and critiques.",
			answer:
